...
Program skrivna i Scala ska ha filnamn som slutar på \texttt{.scala}. Du kan kompilera och köra alla scala-filer i aktuell katalog och alla ev. underkataloger med detta kommando:
\begin{example}
