...
Program skrivna i Scala ska ha filnamn som slutar på \texttt{.scala} till exempel \texttt{hello.scala}. Du kan kompilera och köra alla Scala-filer i aktuell katalog (inkl. alla ev. underkataloger) med detta kommando:
\begin{example}
...
Där \emph{datornamn} är namnet på den dator man vill logga in på. Varje dator i 
datorsalarna har en påklistrad etikett med sitt namn, alltid på formen 
\texttt{salsnamn-N}, t.ex. \texttt{hacke-1}, \texttt{panter-7}, \texttt{lo-6}.
...
\emph{\textbf{Notera:} Man behöver numera dessutom använda VPN för att komma åt 
universitetets resurser hemifrån. Mer information finns på:}

\url{https://www.student.lth.se/stoed-och-service/it-tjaenster-och-support/fjaerraatkomst-och-vpn/}
...
\emph{\textbf{Notera:} Man behöver numera använda VPN för att komma åt 
universitetets resurser hemifrån. Mer information finns på:}
